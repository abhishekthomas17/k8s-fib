...
kubectl set image deployments/client-deployment client=abhitom17/docker-fib-client:$GIT_SHA
kubectl set image deployments/server-deployment server=abhitom17/docker-fib-server:$GIT_SHA
kubectl set image deployments/worker-deployment worker=abhitom17/docker-fib-worker:$GIT_SHA